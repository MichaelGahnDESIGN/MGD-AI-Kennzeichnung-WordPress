...
final class MGD_AI_Image_Labels_GitHub_Updater {
	...
	private static function get_information_sections(): array {
		return array(
			...
			'changelog' => '<h3>Änderungsprotokoll</h3><h4>0.6.10</h4><ul><li>Mehrere gekennzeichnete Bilder werden im Frontend ohne verschachtelte Wrapper oder Verarbeitungsschleife ausgegeben.</li><li>Der MutationObserver ignoriert die vom Plugin selbst erzeugten Kennzeichnungs-Knoten.</li></ul><h4>0.6.9</h4><ul><li>Die GitHub-Update-Prüfung akzeptiert ausschließlich sichere, fest geprüfte Release-Pakete.</li><li>Öffentliche Dokumentation, Sicherheitsrichtlinie und Wiki wurden vervollständigt.</li></ul><h4>0.6.8</h4><ul><li>Die Medienvorschau verwendet nun dieselben Darstellungswerte und CSS-Regeln wie das Frontend.</li><li>Bei Größenänderungen von Modal oder Viewport wird die sichtbare Bildfläche neu vermessen.</li></ul><h4>0.6.7</h4><ul><li>Die Innenabstände der Medienvorschau richten sich mit vier Prozent proportional an der sichtbaren Bildfläche aus.</li></ul><h4>0.6.6</h4><ul><li>Die installierte Plugin-Liste zeigt das lokale MGD-Icon.</li><li>Die Medienvorschau richtet sich an der sichtbaren Bildfläche aus und hält in allen Ecken 18 Pixel Innenabstand.</li></ul><h4>0.6.5</h4><ul><li>Eine rein lokale Live-Vorschau im Medienmodal zeigt Status, Ecke und Glasvariante, ohne etwas zu speichern.</li><li>Beitragsbilder und Divi-Blogkarten werden auch bei responsiven, nachgeladenen sowie WebP- oder AVIF-Quellen eindeutig erkannt.</li></ul><h4>0.6.4</h4><ul><li>KI-Labels werden auch bei Beitragsbildern und Blog-Archivkarten ohne WordPress-Bildklasse ausgegeben.</li></ul><h4>0.6.1</h4><ul><li>Die Speicherung wird nun auch im separaten Laufzeitfenster des Divi-5-Builders geladen.</li><li>Der lokale Speichern-Handler arbeitet ohne jQuery und liest ausschließlich Werte des sichtbaren Anhang-Dialogs.</li></ul><h4>0.6.0</h4><ul><li>Zentrale Verwaltung unter Medien mit globalen Label-Standards, CSS-Klassen und AI-Philosophie ergänzt.</li><li>Hintergrund-Shortcode für Divi-Container und sichere, vorsichtige AI-Philosophie-Seite ergänzt.</li></ul><h4>0.5.3</h4><ul><li>Professionelles lokales Icon und Banner für den WordPress-Update- und Detaildialog ergänzt.</li><li>Native Detailansicht mit Installation, FAQ, Änderungsprotokoll sowie Website-, Dokumentations-, Support- und GitHub-Links ergänzt.</li></ul><h4>0.5.2</h4><ul><li>Gespeicherte Werte nach dem AJAX-Speichern unmittelbar in die aktuelle Ansicht zurückgeschrieben.</li></ul><h4>0.5.1</h4><ul><li>Status „Teilweise KI generiert“ und sicherer GitHub-basierter Update-Mechanismus ergänzt.</li></ul>',
		);
	}
